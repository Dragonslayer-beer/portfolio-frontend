...
const colors = {
  gradients: {
    primary: 'linear-gradient(135deg, #00B4D8 0%, #0077B6 51%, #023E8A 100%)',
...
export const PureLightTheme = createTheme({
  ...
  typography: {
    fontFamily:
      '"notoSansLao", "Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji"',
    h1: {
      fontWeight: 700,
      fontSize: 35
    },
